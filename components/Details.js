              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-4">
                   ...
                   <div className="mb-5">
                    <button className="text-xl font-semibold bg-orange-500 rounded-md py-1 px-5 text-white" onClick={() => {setIsEvo(!isEvo)
                    scrollTo(0, document.body.scrollHeight)
                    }}>{isEvo?'Close':'See Evolutions'}</button>
              {isEvo && (
                <Evolutions setIsEvo={setIsEvo} name={val.name}/>
              )}
                  </div>
              ...
              <div className="flex flex-col gap-5">
                <div className="bg-[#30A7D7]  flex gap-20 py-5 px-10 rounded-lg">
                  ...
                  <div className="flex flex-col gap-5">
                    <div className="flex flex-col gap-1">
                      <p className="text-white text-base font-semibold">Height</p>
                    <p className="text-lg">Max: {currentData?.height.maximum}</p>
                    <p className="text-lg">Min: {currentData?.height.minimum}</p>
                    </div>
                    <div>
                      <p className="text-white text-base font-semibold">Weight</p>
                      <p className="text-lg">Max: {currentData?.weight.maximum}</p>
                      <p className="text-lg">Min: {currentData?.weight.minimum}</p>
                    </div>
