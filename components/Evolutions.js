...
const Evolutions = ({setIsEvo,name}) => {
  ...
  return (
    ...
    <div className=' flex lg:flex-row flex-col rounded-md px-5 py-2 w-full items-center justify-center gap-5 mt-2 bg-[#616161]' onClick={()=>setIsEvo(false)}>
      <div className='flex flex-col items-center p-3'>
         <img className='h-28 w-28  lg:h-44 lg:w-44 rounded-full bg-inherit' src={data?.pokemon?.image} alt="stage 1" />
         <div className='flex flex-col items-center'>
          ...
          <div className='flex gap-2'>{data?.pokemon?.types?.map(type=><p className={
              type === "Poison"
